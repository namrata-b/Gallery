    ...
    public void onBindViewHolder(PhotoViewHolder holder, final int position) {
        ...
        holder.mImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.putExtra(Constants.EXTRA_LEFT, screenLocation[0]).
                        putExtra(Constants.EXTRA_TOP, screenLocation[1]).
                        putExtra(Constants.EXTRA_WIDTH, view.getWidth()).
                        putExtra(Constants.EXTRA_HEIGHT, view.getHeight()).
